<form action="{{ route('movies.update', ['movie' => $movie]) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input id="title" name="title" type="text" class="form-control" placeholder="Inserisci il titolo"
            value="{{ $movie->title }}" />
        @error('title')
            <div class="alert alert-danger mt-2" role="alert">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <input id="description" name="description" type="text" class="form-control"
            placeholder="Inserisci la descrizione" value="{{ $movie->description }}" />
        @error('description')
            <div class="alert alert-danger mt-2" role="alert">
                {{ $message }}
            </div>
    ...
    <div class="form-group">
        ...
        <input id="genre" name="genre" type="text" class="form-control" placeholder="Inserisci la categoria"
            value="{{ $movie->genre }}" />
        @error('genre')
            <div class="alert alert-danger mt-2" role="alert">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <input id="like" name="like" type="text" class="form-control" placeholder="Inserisci I like (max 5)"
            value="{{ $movie->like }}" />
        @error('like')
            <div class="alert alert-danger mt-2" role="alert">
                {{ $message }}
