<form action="{{ route('movies.store') }}" 
    ...
    <div class="form-group">
        ...
        <input id="release_year" name="release_year" type="text" class="form-control"
            placeholder="Anno" value="{{ old('release_year') }}" />
        @error('release_year')
            <div class="alert alert-danger mt-2" role="alert">
                {{ $message }}
            </div>
    ...
    <div class="form-group">
        ...
        <input id="duration" name="duration" type="text" class="form-control"
            placeholder="Durata (hh:mm)" value="{{ old('duration') }}" />
        @error('duration')
            <div class="alert alert-danger mt-2" role="alert">
                {{ $message }}
            </div>
